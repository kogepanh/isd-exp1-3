...
hword moveCP(hword *status,hword cp,hword i,hword j,hword key){
    ...
    if(key==KEY_UP){
        if(status[cp-4*1]==20 || status[cp-4*1]==11){
            ...
            cp0=cp0-4*2-1;
        }else if(status[cp-4*1]==2 || status[cp-4*1]==3 || status[cp-4*1]==4){
            cp0-=4*1;
        ...
        if(status[cp-1]==10){
            ...
            cp0=cp0-4*1-2;
        }else if(status[cp-1]==1 || status[cp-1]==3 || status[cp-1]==4){
            cp0--;
...
hword moveI(hword *status,hword cp,hword i,hword j,hword key){
    ...
    if(key==KEY_UP){
        if(status[cp-4*1]==20 || status[cp-4*1]==30 || status[cp-4*1]==11){
            i0-=2;
        }else if(status[cp-4*1]==2 || status[cp-4*1]==12 || status[cp-4*1]==3 || status[cp-4*1]==4){
            i0--;
        }
    }else if(key==KEY_DOWN){
        if((status[cp]==0 || status[cp]==1) && i<3){
        ...
        if(((status[cp]==1 || status[cp]==3 || status[cp]==4) && (status[cp+1]==20 || status[cp+1]==11))
            || (j<2 && (status[cp]==0 || status[cp]==2) && (status[cp+2]==20 || status[cp+2]==11))){
            i0--;
        }
    }
    return i0;
...
hword moveJ(hword *status,hword cp,hword i,hword j,hword key){
    ...
    if(key==KEY_UP){
        ...
        if(((status[cp]==2 || status[cp]==3 || status[cp]==4) && (status[cp+4*1]==10 || status[cp+4*1]==12))
            || ((status[cp]==0 || status[cp]==1) && (status[cp+4*2]==10 || status[cp+4*2]==12))){
            j0--;
        }
    }else if(key==KEY_LEFT){
        if(status[cp-1]==10){
...
void message(){
    ...
    for(i=0;i<12;i++){
        for(j=0;j<48;j++){
            if((i==0 || i==1) && !(j==0 || j==1 || (5<j && j<10) || (11<j && j<20) || (27<j && j<32) || (35<j && j<40) || j==46 || j==47)){
                *(ptr+j)=WHITE;
            }else if((i==2 || i==3) && !((1<j && j<6) || j==8 || j==9 || (11<j && j<20) || (21<j && j<30) || (31<j && j<36) || j==38 || j==39 || (41<j && j<46))){
                *(ptr+j)=WHITE;
            }else if((i==4 || i==5) && !((1<j && j<10) || (11<j && j<20) || (25<j && j<30) || (31<j && j<36) || j==38 || j==39 || (41<j && j<46))){
                *(ptr+j)=WHITE;
            }else if((i==6 || i==7) && !((1<j && j<10) || (11<j && j<20) || (21<j && j<30) || j==38 || j==39 || j==46 || j==47)){
                *(ptr+j)=WHITE;
            }else if((i==8 || i==9) && !((1<j && j<6) || j==8 || j==9 || (11<j && j<20) || (21<j && j<30) || (31<j && j<36) || j==38 || j==39 || (41<j && j<46))){
                *(ptr+j)=WHITE;
            }else if((i==10 || i==11) && !(j==0 || j==1 || (5<j && j<10) || j==18 || j==19 || j==28 || j==29 || (31<j && j<36) || j==38 || j==39 || (41<j && j<46))){
                *(ptr+j)=WHITE; 
            }
        }
        ptr+=240;
